  ...
  return (
    <>
      ...
      <div className="bg-white p-6 rounded shadow-sm border mb-6">
        <h1 className="text-xl font-bold border-b-2 border-blue-900 inline-block mb-4">
          Komiku
        </h1>
      ...
      <div className="bg-white p-6 rounded shadow-sm border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded text-blue-700 font-medium cursor-pointer">
            History →
          </div>
          <div className="bg-blue-50 p-4 rounded text-blue-700 font-medium cursor-pointer">
            Bookmark →
